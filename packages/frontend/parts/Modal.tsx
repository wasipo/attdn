...
export const StartOverTime = () => {
    return (
        <div className="mt-6 block">
            ...
            <input name="startOverTime" type="text" className="mt-1 py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md border" />
        </div>
    )
};
...
export const EndOverTime = () => {
    return (
        <div className="mt-3 block">
            ...
            <input name="endOverTime" type="text" className="mt-1 py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md border" />
        </div>
    )
};
