...
import {WorkScheduleType} from "../lib/data/WorkSchedule";
...
export const Modal = (props: WorkScheduleProps) => {
  ...
  const getModalRow = (): WorkScheduleType => {
    // @ts-ignore
    return props.fields.find(field => props.targetRow === field.rowNumber)
  }

  return (
    <Transition.Root show={props.isShow} as={Fragment}>
      <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={() => false}>
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <OverTime rowNumber={1} register={props.register} workScheduleType={getModalRow()} inputName={'aaaa'}/>
                  </div>
                </div>
              </div>
